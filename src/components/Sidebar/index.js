    ...
    return (
      <div className="Sidebar">
        ...
        <div className="ButtonGroup">
          <a className={["SidebarButton", this.state.selectedButton == "profile" ? 'active' : ''].join(' ')} id="profile" onClick={this.onButtonPress}>
            <img className="icon" src={this.state.selectedButton == "profile" ? '../images/profile-active.svg' : '../images/profile.svg'}/>
          </a>
          <a className={["SidebarButton", this.state.selectedButton == "friend" ? 'active' : ''].join(' ')} id="friend" onClick={this.onButtonPress}>
            <img className="icon" src={this.state.selectedButton == "friend" ? '../images/friend-active.svg' : '../images/friend.svg'}/>
          </a>
          { this.state.selectedButton == "friend"
                ? (
                    <div className="FriendMenu">
                        <div className="border"></div>
                        <p>Friends</p>
                        <div className="MenuLinkGroup">
                            <a onClick={this.onFriendPress}> Emma </a>
                            <a onClick={this.onFriendPress}> Zac </a>
                            <a onClick={this.onFriendPress}> Linford </a>
                            <a onClick={this.onFriendPress}> Ally </a>
                            <a onClick={this.onFriendPress}> Himadri </a>
                        </div>
          ...
          <a className={["SidebarButton", this.state.selectedButton == "group" ? 'active' : ''].join(' ')} id="group" onClick={this.onButtonPress}>
            <img className="icon" src={this.state.selectedButton == "group" ? '../images/group-active.svg' : '../images/group.svg'}/>
          </a>
          { this.state.selectedButton == "group"
                ? (
                    <div className="GroupMenu">
                        <div className="border"></div>
                        <p>Groups</p>
                        <div className="MenuLinkGroup">
                            <a onClick={this.onGroupPress}> Dartmouth </a>
                            <a onClick={this.onGroupPress}> Club Swim </a>
                            <a onClick={this.onGroupPress}> Taco Lovers of America Wow</a>
                        </div>
                        <a className="addButton">+ add friend </a>
                    </div>
                )
